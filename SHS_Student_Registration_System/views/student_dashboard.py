...
# Purpose: Student dashboard UI displaying student information, registration status, and navigation options.
# This follows OOP by encapsulating all dashboard widgets and data loading logic in a single class.
...
# StudentDashboard class - OOP: Encapsulates student dashboard UI and data display logic
# This is an OOP class because it groups related UI components (labels, status fields, buttons) and
# data loading methods into a cohesive unit, following encapsulation principles.
class StudentDashboard(QWidget):
    def __init__(self, main_window, controller):
        ...
        # Widget: Main shape container - the large dashboard container
        ...
        # Widget: Header bar - red header bar at the top of the dashboard
        ...
        # Widget: Header label - displays "STUDENT DASHBOARD" text in the header bar
        ...
        # Widget: LRN label - displays the student's Learner Reference Number
        ...
        # Widget: Full name label - displays the student's full name
        ...
        # Widget: School year label - displays the current school year from registration
        ...
        # Widget: Grade level label - displays the student's grade level
        ...
        # Widget: Track-Strand label - displays the student's track and strand
        ...
        # Widget: Status field - displays registration status (Pending/Approved/Rejected) with color coding
        ...
        # Widget: View registration summary button - navigates to detailed registration summary view
        ...
        # Widget: Logout button - logs out the current user and returns to login page
    ...
    # Method: Load and display student data from the database based on account ID
    ...
    # Method: Handle view summary button click - navigate to registration summary view
    ...
    # Method: Handle logout button click - clear user session and return to login
