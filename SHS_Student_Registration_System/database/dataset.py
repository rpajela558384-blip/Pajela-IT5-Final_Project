# database/dataset.py
# Purpose: Script to insert sample data into all database tables. Creates 6 student records,
# 3 registrar accounts, 1 admin account, and all related data (addresses, academic records,
# parent/guardian info, employees, registration records, and documents).

import mysql.connector
from database.connect_database import get_connection_params

# Function: Insert sample data into all database tables for testing and development
